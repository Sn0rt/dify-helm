...
{{- end }}
{{- if and .Values.api.otel.enabled .Values.api.otel.apiKey (not .Values.externalSecret.enabled) }}
...
INNER_API_KEY_FOR_PLUGIN: {{ .Values.pluginDaemon.auth.difyApiKey | b64enc | quote }}
{{- end }}
{{- if and .Values.worker.otel.enabled .Values.worker.otel.apiKey (not .Values.externalSecret.enabled) }}
